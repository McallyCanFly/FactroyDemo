...
        private SQLiteHelper()
       ...
       public static string connectionString = ConfigurationManager.AppSettings["SQLiteConnectionString"];
        ...
        /// <summary>
        /// 返回一个 SQLiteCommand 命令
        /// Mcally  2019年2月17日14:09:56
        /// </summary>
        ...
        /// <returns></returns>
        public static SQLiteCommand CreateCommand(string sql, CommandType type = CommandType.Text, params SQLiteParameter[] commandParameters)
        {
            SQLiteCommand cmd = new SQLiteCommand(sql, new SQLiteConnection(connectionString));
        ...
        /// <summary>
        /// Mcally 2019年2月17日14:01:51
        /// 实用性出发
        /// 执行查询返回DataTable
        /// </summary>
        /// <param name="commandText">sql字符串</param>
        /// <param name="sQLiteParameters">参数数组</param>
        /// <param name="type">文本类型</param>
        /// <returns></returns>
        public static DataTable ExecuteDataTable(string commandText, SQLiteParameter[] sQLiteParameters = null, CommandType type = CommandType.Text)
        {
...
                dataAdapter.UpdateCommand = updateCommand;
        ...
        public static T ExecuteScalar<T>(string sql, CommandType type = CommandType.Text, params object[] paramList)
        {
            object result = null;
            using (SQLiteConnection cn = new SQLiteConnection(connectionString))
            {
